...
1. defects4j-specific: This directory contains scripts used to annotate Defects4J defects.
   ...
   - **getTestcaseDetails.sh** annotates TriggeringTestCount and
     ...
     setting the environment variable PATH to <path-to-Defects4J>/framewor/bin. The input to the script required is project, start  DefectId and end DefectId (e.g. Chart 1 26). The output generated by the script is file Defects4JTests.csv 
